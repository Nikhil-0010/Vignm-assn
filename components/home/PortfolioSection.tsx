...
export default function PortfolioSection() {
    const [selectedElIdx, setSelectedElIdx] = useState<number | null>(0);
    const list = [
        {
  ...
  return (
    <section className="w-full bg-black px-4 py-6 pt-16 flex flex-col space-y-16 justify-between">
      <div className="flex flex-col space-y-6">
        ...
        <h1 className="text-4xl lg:text-6xl text-white tracking-tight">
      ...
      <div className="border-t-[1.4px] border-stone-700 pt-4 flex flex-col gap-8 lg:gap-0 lg:flex-row justify-between">
        <div className="w-full lg:w-2/5 aspect-video relative overflow-hidden rounded">
          <Image
